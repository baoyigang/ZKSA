    ...
    public partial class Main : Form
    {
        ...
        string FormDialog_OnDialog(DialogEventArgs args)
        {
            ...
            else
            {
                ...
                if (args.Message[0] == "1")//盘点
                {
                    View.Dispatcher.frmInTask frm = new View.Dispatcher.frmInTask(int.Parse(args.Message[0]), args.dtInfo);
                    if (frm.ShowDialog() == DialogResult.OK)
                    {
                        strValue = frm.strValue;
                    }
        ...
        private void toolStripButton_InStockTask_Click_1(object sender, EventArgs e)
        {
            App.View.Task.frmInStock f = new View.Task.frmInStock();
            ShowForm(f);
        }
        ...
        {
            App.View.Dispatcher.frmMoveCount f = new App.View.Dispatcher.frmMoveCount();
            f.ShowDialog();
        }
