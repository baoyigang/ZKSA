...
namespace App.View
{
    public partial class frmMonitor1 : BaseForm
    {
        ...
        int lastPanelVerticalScrollValue = -1;
        ...
        {
            if (!(panel1.VerticalScroll.Visible == false || (panel1.VerticalScroll.Value == 0 && e.Delta > 0) || (panel1.VerticalScroll.Value == lastPanelVerticalScrollValue && e.Delta < 0)))
            {
                panel1.VerticalScroll.Value += 10;
                lastPanelVerticalScrollValue = panel1.VerticalScroll.Value;
                panel1.Refresh();
                panel1.Invalidate();
                panel1.Update();
            }
