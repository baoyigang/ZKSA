...
namespace App.View.Task
{
    public partial class frmCraneTask : BaseForm
    {
        ...
        {
            //Context.ProcessDispatcher.WriteToService("ERP", "SED", this.txtNo.Text);
        }
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            try
            {
                string TaskNo = txtNo.Text;

                string serviceName = "MiniLoad0" + txtp.Text;

                int[] cellAddr = new int[6];
                cellAddr[0] = int.Parse(txtSL.Text);
                cellAddr[1] = int.Parse(txtSC.Text);
                cellAddr[2] = int.Parse(txtSP.Text);
                cellAddr[3] = int.Parse(txtTL.Text);
                cellAddr[4] = int.Parse(txtTC.Text);
                cellAddr[5] = int.Parse(txtTP.Text);

        

                Context.ProcessDispatcher.WriteToService(serviceName, "TaskAddress1", cellAddr);
                Context.ProcessDispatcher.WriteToService(serviceName, "TaskNo1", TaskNo);
                Context.ProcessDispatcher.WriteToService(serviceName, "TaskType1", 1);

                cellAddr[0] = int.Parse(txtSL2.Text);
                cellAddr[1] = int.Parse(txtSC2.Text);
                cellAddr[2] = int.Parse(txtSP2.Text);
                cellAddr[3] = int.Parse(txtTL2.Text);
                cellAddr[4] = int.Parse(txtTC2.Text);
                cellAddr[5] = int.Parse(txtTP2.Text);

                Context.ProcessDispatcher.WriteToService(serviceName, "TaskAddress2", cellAddr);
                Context.ProcessDispatcher.WriteToService(serviceName, "TaskNo2", this.txtNo2.Text);
                Context.ProcessDispatcher.WriteToService(serviceName, "TaskType2", 1);
        ...
        {
            string StationLoad1 = txtServerName.Text;
            string StationLoad2 = txtItemName.Text;
