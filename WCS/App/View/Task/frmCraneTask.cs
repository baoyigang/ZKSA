...
namespace App.View.Task
{
    public partial class frmCraneTask : BaseForm
    {
        ...
        {
            DataTable dt = bll.FillDataTable("CMD.SelectCrane", new DataParameter[] { new DataParameter("{0}", "Crane.State='1'") });
        ...
        private void btnAction_Click(object sender, EventArgs e)
        {
            ...
            Context.ProcessDispatcher.WriteToService(serviceName, "TaskNo", this.txtTaskNo1.Text);
