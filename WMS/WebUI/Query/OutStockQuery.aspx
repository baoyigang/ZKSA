<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OutStockQuery.aspx.cs" Inherits="WebUI_Query_OutStockQuery" %>
                    ...
                    <tr>
                        ...
                        <td align= "left" style="border-left:2px solid #ffffff;">
                             &nbsp;<asp:Button ID="btnSearch" runat="server" CssClass="ButtonQuery" 
                                ...
                                onclientclick="return PrintClick();" onclick="btnPreview_Click" /> &nbsp;&nbsp;
